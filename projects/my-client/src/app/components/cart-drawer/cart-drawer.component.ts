import { Component, computed, effect, HostListener, OnDestroy, signal, untracked } from '@angular/core';
...
export class CartDrawerComponent implements OnDestroy {
  ...
  constructor(
    ...
    // — nếu không, mỗi lần .set() tạo Set mới (khác reference) sẽ tự kích hoạt lại effect này vô hạn lần,
    // treo cứng tab trình duyệt (biểu hiện: màn hình đen, "Page Unresponsive").
    effect(() => {
